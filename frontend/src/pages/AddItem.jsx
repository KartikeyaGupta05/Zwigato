...
function AddItem() {
  ...
  return (
    <div className="flex justify-center flex-col items-center p-6 bg-[#fff9f6] min-h-screen">
      <div
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div
              ...
              className="w-full h-40 border-2 border-dashed border-orange-300 rounded-xl flex flex-col items-center justify-center cursor-pointer bg-orange-50 hover:bg-orange-100 transition"
            >
              {!frontendImage ? (
                <>
                  <FaUtensils className="text-orange-400 text-3xl mb-2" />
