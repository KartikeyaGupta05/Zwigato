...
function Nav() {
  ...
  return (
    <div className="w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-[#fff9f6] overflow-visible">
        ...
        <div className="w-[90%] h-[70px]  bg-white shadow-xl rounded-lg items-center gap-[20px] flex fixed top-[80px] left-[5%] md:hidden">
          ...
          <div className="w-[80%] flex items-center gap-[10px]">
            ...
            <input
              ...
              className="px-[10px] text-gray-700 outline-0 rounded-xl w-full"
      ...
      <h1 className="text-3xl font-bold mb-2 text-[#ff4d2d]">Zwigato</h1>
      {userData.role == "user" && (
      ...
      <div className="flex items-center gap-4">
        ...
        {userData.role == "owner" ? (
          ...
          <>
            ...
            <button
              className="hidden md:block px-3 cursor-pointer py-1 rounded-lg bg-[#ff4d2d]/10 text-[#ff4d2d] text-sm font-medium"
              onClick={() => navigate("/my-orders")}
            >
              My Orders
            </button>
        ...
        <div
          className="w-[40px] h-[40px] rounded-full flex capitalize items-center justify-center bg-[#ff4d2d] text-white text-[18px] shadow-xl font-semibold cursor-pointer"
        ...
        {showInfo && (
          ...
          >
            <div className="text-[17px] capitalize font-semibold">
              {userData.fullName}
            </div>
            {userData.role == "user" && (
              <div
